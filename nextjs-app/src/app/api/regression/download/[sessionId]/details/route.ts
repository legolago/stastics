// app/api/regression/sessions/[sessionId]/route.ts
...
export async function GET(
  ...
  try {
    ...
    console.log(`🔗 Getting regression session ${sessionId} from:`, fastApiUrl);
    
    const response = await fetch(`${fastApiUrl}/api/regression/sessions/${sessionId}`);
    ...
    console.log(`✅ Regression session ${sessionId} retrieved successfully`);
    ...
    console.error('❌ Regression session error:', error);
    return NextResponse.json(
      { 
        success: false,
